...
with st.sidebar:
    ...
    vehicle_types_sel = st.multiselect("Vehicle types", ["car","bus","truck","motorcycle","ridehail"], default=["car","bus","truck","motorcycle","ridehail"])
...
st.download_button("Download filtered CSV", data=to_csv(df_f), file_name="vehicle_emissions_filtered.csv", mime="text/csv")
excel_bytes = to_excel_bytes(df_f)
if excel_bytes is not None:
    st.download_button("Download filtered Excel", data=excel_bytes, file_name="vehicle_emissions_filtered.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
else:
